...
class CalendarUtils
{
  ...
  /**
   * Set globally afghan months names as categories month name
   *
   * @return void
   */
  ...
  /**
   * Set globally iranian months names as categories month name
   *
   * @return void
   */
   ...
   *
   * @param string $string
   * @param boolean $toEnglish , categories is false to save compatiblity
   * @return string
   */
