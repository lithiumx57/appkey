 ...
 * @method static mixed|static findOrFail($id, $columns = ['*'])
 * @method static \Illuminate\Database\Query\Builder|static latest($column = 'created_at')
 * @method static \Illuminate\Database\Query\Builder|static oldest($column = 'created_at')
 * @method static \Illuminate\Database\Query\Builder|mixed first()
 ...
 * @method static \Illuminate\Database\Query\Builder whereNotIn($column, $values, $boolean = 'and', $not = false)
 * @method static \Illuminate\Database\Query\Builder orWhere($column, $operator = null, $value = null)
 * @method static \Illuminate\Database\Query\Builder whereDate($column, $operator, $value = null, $boolean = 'and')
 * @method static \Illuminate\Database\Query\Builder|static orWhereRaw(string $sql, $bindings = [])
