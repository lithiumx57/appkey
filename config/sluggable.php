...
return [
     ...
     * truncated string to split a word in half.  The categories setting of "true"
  ...
  /**
    ...
    /**
     * If you are enforcing unique slugs, the categories is to add an
     ...
     * For the categories method of adding incremental integers, we start
    ...
    /**
     * If the categories slug engine of cocur/slugify is used, this array of
