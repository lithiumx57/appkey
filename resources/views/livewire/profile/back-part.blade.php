<div>
  <div class="back-part desktop-show mobile-hidden">
    <div style="display: flex;justify-content: space-between;border-bottom: 1px solid var(--border-color);padding-bottom: 8px;margin-bottom: 8px">
      @if($href!="/profile")
        <a wire:navigate  href="{{$href}}" data-change-url="true" class="livewire-mode" data-emit="{{$emit}}" data-listener="profile-navigation-changed" style="display: flex;align-items: center;text-decoration: none">
