  ...
  <div class="auth-container box">
    <div class="x-container">
      ...
      <div class="login-input-container">
        @if($mode=="index")
          <input type="tel" wire:model="phone" wire:keyup.Enter="sendCode" class="login-input" id="mobile-phone">
        @else
          <input type="tel" wire:model="code"  wire:keyup.Enter="confirmCode" class="login-input" id="mobile-code">
        @endif
        @if($errorText)
